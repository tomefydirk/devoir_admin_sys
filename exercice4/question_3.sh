...
touch ./test/nv_fichier_dans_test 

    #resultat :(
        #touch: impossible de faire un touch './test/nv_fichier_dans_test': Permission non accordée
    #)
...
rmdir ./test/sstest 
    ...
    #resultat :(
        #rmdir: impossible de supprimer './test/sstest': Permission non accordée
    #)

#modifier un fichier dans le repertoire test:
rm ./test/essai #resultat :

    #resultat :(
        #rm: impossible de supprimer './test/essai': Permission non accordée
    #)
...
cp -f ./test/essai ./
     ...
     #resultat  : (
        #cp: impossible d'évaluer './test/essai': Permission non accordée
    #)
...
cat ./test/essai  
    ...
    #resultat : 
        #(cat: ./test/essai: Permission non accordée
    #)
